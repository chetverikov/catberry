...
class StateProviderBase {
   ...
   * @return {Object|null} The state object.
   */
  getStateByUri(uri) {
   ...
   * @return {Object|null} The state from URI.
   * @private
   */
  _mapState(uri) {
    let state = null;
   ...
   * @return {Array} The list of URI mappers.
   * @private
   */
  _getUriMappers() {
   ...
   * @return {Array} The list of route descriptors.
   * @protected
   * @abstract
   */
