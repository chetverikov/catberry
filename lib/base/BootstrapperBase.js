...
const {html, Template} = require('../template');
...
class BootstrapperBase {
   ...
   * @return {Catberry} The Catberry application instance.
   */
  create(configObject) {
  ...
  configure(configObject, locator) {
    ...
    locator.registerInstance('html', html);
    locator.registerInstance('Template', Template);
