...
class RouteParser {
   ...
   * @return {{expression: string, pathParameters: Array, queryParameters: Array, pathRegExpSource: string}}
   * Route descriptor.
   * @private
   */
   ...
   * @return {Array} List of parameter descriptors.
   * @private
   */
 ...
 * @return {string} Regular expression source.
 */
 ...
 * @return {{start: number, end: number, name: null, stores: {}}}
 */
 ...
 * @return {string} The string with specified number of spaces.
 */
