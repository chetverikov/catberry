...
class ComponentLoader extends LoaderBase {
   ...
   * @return {Promise<Object>} The promise for map of loaded components.
   */
  load() {
   ...
   * @return {Object} The map of components by their names.
   */
   ...
   * @return {string} The absolute path to the logic file.
   * @private
   */
