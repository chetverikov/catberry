...
class StoreFinder extends events.EventEmitter {
   ...
   * @return {Promise<Map>} The Promise for Map of found stores by names.
   */
  find() {
   ...
   *
   * @return {Promise} Promise resolve when watches will be ready
   */
  watch() {
   ...
   * @return {{name: string, path: string}} The store descriptor.
   * @private
   */
