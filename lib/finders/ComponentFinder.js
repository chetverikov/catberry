...
class ComponentFinder extends events.EventEmitter {
   ...
   * @return {Promise<Map>} Promise for Map of found components by their names.
   */
  find() {
   ...
   * @return {{name: string, path: string, properties: Object}|null} The found
   ...
   * @return {string} The path which is relative to CWD.
   */
