...
class ComponentLoader extends LoaderBase {
   ...
   * @return {Promise<Object>} The promise for loaded components.
   */
  load() {
   ...
   * @return {Promise<Object>} The promise for the component object.
   * @private
   */
  _processComponent(componentDetails) {
    let component = Object.create(componentDetails);
   ...
   * @return {Object} The map of the components by their names.
   */
