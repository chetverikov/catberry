...
class DocumentRenderer extends DocumentRendererBase {
   ...
   * @return {Promise} Promise for nothing.
   */
   ...
   * @return {Promise} Promise resolve when component will be render
   */
  renderComponent(element, renderingContext) {
    return this._getPromiseForReadyState()
      .then(() => {
        ...
        const $context = this._getComponentContext(component, element);
   ...
   * @return {Object} The found component object.
   */
   ...
   * @param {string} selector Selector for the query.
   * @param {Object?} parentComponent Parent component object.
   * @return {Array} The found component object list.
   */
   ...
   * @return {Promise<Element>} Promise for HTML element with the rendered component.
   */
   ...
   * @return {Promise} Promise for finished removal
   * @private
   */
   ...
   * @return {Promise} Promise for the removed component.
   * @private
   */
   ...
   * @return {Function} Universal event handler for delegated events.
   * @private
   */
   ...
   * @return {Boolean} true if element is a component
   * @private
   */
   ...
   * @return {Array} Array of the component objects.
   * @private
   */
   ...
   * @return {Promise} Promise for the finished traversal.
   * @private
   */
   ...
   * @return {Element[]} Return child elements (components) for the specified component
   * @private
   */
   ...
   * @return {Promise<string>} Promise for HTML string.
   * @private
   */
   ...
   * @param {Object} components Current set of components.
   * @return {Promise} Promise for the done initialization.
   * @private
   */
   ...
   * @return {Object} Component's context.
   * @private
   */
  _getComponentContext(component, element) {
    ...
    Object.defineProperties(componentContext, {
      ...
      storeParams: {
        get: () => moduleHelper.getStoreParamsFromAttributes(attributesToObject(element.attributes)),
        enumerable: true,
      },
      storeInstanceId: {
        get: () => {
          ...
          return moduleHelper.getStoreInstanceId(storeName, storeParams);
        },
        enumerable: true,
      },
    });
    ...
    componentContext.getStoreData = () => {
      ...
      return this._storeDispatcher.getStoreData(storeName, storeParams);
    };
    componentContext.sendAction = (name, args) => {
      ...
      return this._storeDispatcher.sendAction(storeInstanceId, name, args);
    };
 ...
 * @return {Object} Map of attribute values by their names.
 */
 ...
 * @return {boolean} Does the element match.
 */
 ...
 * @return {boolean} true if element should not be mutated.
 */
